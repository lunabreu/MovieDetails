...
class DetailsView : UIView {
    ...
    init(view: UIView, parent: UIViewController) {
        ...
        imageView = UIImageView(frame: CGRect(x: 0, y: 0, width: width, height: height*0.6))
        ...
        titleLabel.frame.origin.y = imageView.frame.origin.y + height * 0.45
        ...
        likesNumber = UILabel(frame: CGRect(x: 0, y: 0, width: width*0.2, height: 25))
        ...
        watchedLabel = UILabel(frame: CGRect(x: 0, y: 0, width: width*0.275, height: 25))
        ...
        watchedIcon = UIImageView(frame: CGRect(x: width * 0.05, y: 0, width: 15, height: 15))
        watchedIcon.contentMode = .scaleAspectFit
        watchedIcon.frame.origin.x = watchedLabel.frame.origin.x + watchedLabel.frame.width + 1
        watchedIcon.center.y = watchedLabel.center.y
        watchedIcon.image = UIImage (named: "transmissionIcon")?.withTintColor(UIColor.white)
        
        scrollView.addSubview(watchedIcon)
        
        var yPosition = watchedLabel.frame.origin.y + watchedLabel.frame.height + 5
        
        //------------------------- Table View -----------------------------
        
        tableView = UITableView(frame: CGRect(x: 0, y: yPosition, width: width, height: height * 0.45))
    ...
    @objc func likeButtonAction() {
        ...
        if likeButton.imageView?.image == UIImage (named: "unlikedButton")?.withTintColor(UIColor.white) {
            ...
            likeButton.setImage(UIImage(named: "likedButton")?.withTintColor(UIColor.white), for: .normal)
